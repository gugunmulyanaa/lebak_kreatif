...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bgi.png'); ?>');">
    <div class="container">
    ...
    <div class="container">
        ...
        <div class="col-md-3 d-flex">
            <div class="info bg-white p-4">
              <p><span>Alamat </span>J6QX+R9P, Rangkasbitung Bar., Kec. Rangkasbitung, Kabupaten Lebak, Banten 42312</p>
            </div>
        </div>
        <div class="col-md-3 d-flex">
            <div class="info bg-white p-4">
              <p><span>Telp:</span> 0252-201072</p>
            </div>
        </div>
        <div class="col-md-5 d-flex">
            <div class="info bg-white p-4">
              <p><span>Email:</span> dispar.kablebak@gmail.com</p>
            </div>
        </div>
        
      </div>
      <div class="row block-9">
        <div class="col-md-11 order-md-last d-flex">
        ...
        <div class="col-md-11 d-flex">
            <div style="width: 100%">
                <iframe width="100%" height="600" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.259876020096!2d106.24625251527664!3d-6.360401263993577!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e4217170cedf319%3A0x3969cc294382e684!2sDinas%20Kebudayaan%20dan%20Pariwisata%20(Disbudpar)%20Kabupaten%20Lebak!5e0!3m2!1sid!2sid!4v1656226410256!5m2!1sid!2sid" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" frameborder="0" scrolling="no" marginheight="0" marginwidth="0">
