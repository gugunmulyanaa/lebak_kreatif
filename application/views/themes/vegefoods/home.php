...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/lebak.png'); ?>);">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2"></h1>
            <h2 class="subheading mb-3">Silahkan Login terlebih dahulu</h2>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2"></h1>
            <h2 class="subheading mb-3">Belum punya akun? daftar sekarang</h2>
            <p><a href="#products" class="btn btn-info">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span> Produk UMKM Lebak</span>        </div>
      </div>      
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
  ...
  <div class="container">
    ...
    <div class="col-md-12 heading-section text-center ftco-animate">
      ...
      <h2 class="mb-4">Lebak Kreatif</h2>
      <p>Kategori produk:</p>
    </div>
    <div class="text-center d-flex align-self-stretch ftco-animate">
    <p><a href="index.php/shop/product/10/AMXA410449/" class="btn btn-info">Makanan</a></p>&nbsp;
    <p> <a href="index.php/shop/product/13/SWWWBBBLB410156/" class="btn btn-info">Barang</a></p>
    </div>  
  </div>   		
  </div>
  <div class="container">
