...
class Products extends CI_Controller {
    ...
    {
        $params['title'] = 'Kelola Voucher Belanja';
    ...
    public function coupon_api()
    {
        ...
        switch ($action) {
            ...
            case 'delete_coupon' :
                ...
                $response = array('code' => 204, 'message' => 'Voucher berhasil dihapus!');
            break;
            case 'edit_coupon' :
                $id = $this->input->post('id');
                $name = $this->input->post('name');
                ...
                $response = array('code' => 201, 'message' => 'Voucher berhasil diperbarui');
            break;
        }
