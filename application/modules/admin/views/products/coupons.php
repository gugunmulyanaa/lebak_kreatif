        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Kelola Voucher Belanja</h6>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <h3 class="mb-0">Kategori Voucher</h3>
            </div>
          ...
          <div class="modal-body p-0">
              <div class="card bg-secondary border-0 mb-0">
                  <div class="card-header bg-transparent">
                      <h3 class="card-heading text-center mt-2">Tambah Voucher</h3>
                  </div>
                      ...
                      <form role="form" action="#" method="POST" id="addCouponForm">
                          ...
                          <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="name" class="form-control" placeholder="Nama Voucher" type="text" maxlength="255" required>
                                </div>
                          ...
                          <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="code" class="form-control" placeholder="Kode Voucher " type="text" maxlength="255" required>
                                </div>
                          ...
                          <div class="float-right" style="margin-top: -90px">
                            <button type="submit" class="btn btn-info my-4 addPackageBtn">Tambah</button>
                        </div>
                      </form>
                  </div>
              </div>
  ...
  <div class="modal-dialog modal-modal-dialog-centered modal-" role="document">
      <div class="modal-content">
          <div class="modal-header">
              <h6 class="modal-title" id="modal-title-default">Hapus Voucher</h6>
  ...
  <div class="modal-dialog modal- modal-dialog modal-md" role="document">
      <div class="modal-content">
          <div class="modal-body p-0">
              <div class="card bg-secondary border-0 mb-0">
                  <div class="card-header bg-transparent">
                      <h3 class="card-heading text-center mt-2">Edit Voucher</h3>
                  </div>
                  <div class="card-body px-lg-5 py-lg-5">
                      <form role="form" action="#" method="POST" id="editCouponForm">
                        ...
                        <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="name" class="form-control edit-name" placeholder="Nama Voucher" type="text" maxlength="255" required>
                                </div>
                                <div class="text-danger err name-error"></div>
                          </div>
                          ...
                          <div class="form-group mb-3">
                              <div class="input-group input-group-merge input-group-alternative">
                                  ...
                                  <input name="code" class="form-control edit-code" placeholder="Kode Voucher " type="text" maxlength="255" required>
                                </div>
                                <div class="text-danger err code-error"></div>
                          </div>
                          ...
                          <div class="form-group mb-3">
                                <label for="av" class="form-control-label">
                                    <input type="checkbox" name="is_active" value="1" id="av"> Voucher ini masih tersedia
                                </label>
                          </div>
                          ...
                          <div class="float-right" style="margin-top: -90px">
                            <button type="submit" class="btn btn-info my-4 editPackageBtn">Simpan</button>
                        </div>
                      </form>
                  </div>
              </div>
