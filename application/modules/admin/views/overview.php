              ...
              <?php foreach ($customers as $customer) : ?>
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                      <a href="<?php echo site_url('admin/customers/view/'. $customer->id); ?>" class="btn btn-sm btn-info">Profil</a>
                    </div>
                  </div>
                </li>
                <?php endforeach; ?>
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="<?php echo site_url('admin/products'); ?>" class="btn btn-sm btn-info">Lihat semua</a>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="<?php echo site_url('admin/products/category'); ?>" class="btn btn-sm btn-info">Lihat semua</a>
                </div>
              </div>
            </div>
            <div class="table-responsive">
