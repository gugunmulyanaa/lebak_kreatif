...
(function (global, factory) {
  ...
  var videoDialog = function (opt) {
      var body = '<div class="note-form-group">' +
          ...
          '</div>';
      var footer = [
          '<button type="button" href="#" class="note-btn note-btn-info note-video-btn disabled" disabled>',
  ...
  var imageDialog = function (opt) {
      var body = '<div class="note-form-group note-group-select-from-files">' +
          ...
          '</div>';
      var footer = [
          '<button href="#" type="button" class="note-btn note-btn-info note-btn-large note-image-btn disabled" disabled>',
      ...
      var body = '<div class="note-form-group">' +
          ...
          (!opt.disableLinkTarget
              ? '<div class="checkbox">' +
                  ...
                  '</div>' : '');
      var footer = [
          '<button href="#" type="button" class="note-btn note-btn-info note-link-btn disabled" disabled>',
